...
func (c *authClient) GetPermission(ctx context.Context, in *GetPermissionRequest, opts ...grpc.CallOption) (*Permission, error) {
	out := new(Permission)
	err := c.cc.Invoke(ctx, "/oci.cloud.permission.Auth/GetPermission", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedAuthServer) GetPermission(context.Context, *GetPermissionRequest) (*Permission, error) {
...
func _Auth_GetPermission_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/oci.cloud.permission.Auth/GetPermission",
	}
...
var Auth_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "oci.cloud.permission.Auth",
	...
	Metadata: "auth/permission.proto",
}
